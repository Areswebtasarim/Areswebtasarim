@extends('admin.tema')
@section('admintitle') Düzenleme işlemler @endsection
@section('css')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="basic-form">
                                <form action="{{route('duzenlepost',[$modulBilgisi->selflink,$veriler->id])}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="metin" class="summernote" >{{$veriler->metin}}
                                </div>
                                        ...
                                        <div class="form-group">
                                            <label>Sıra No</label>
                                            <input type="number" class="form-control input-default" placeholder="Sırano" name="sirano" value="{{$veriler->sirano}}" required>
                                        </div>
                                        <div class="form-group">
